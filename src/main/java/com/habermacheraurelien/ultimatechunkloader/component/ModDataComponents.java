...
public class ModDataComponents {
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<Integer>> COORDINATE_X =
            register("chunk_coordinate_x", builder -> builder.persistent(Codec.INT));
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<Integer>> COORDINATE_Z =
            register("chunk_coordinate_z", builder -> builder.persistent(Codec.INT));
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<Boolean>> CHUNK_LOADED =
