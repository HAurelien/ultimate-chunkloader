...
public class ModCreativeModTabClass {
    ...
    private static final String COMMAND_TAB_ID =  UltimateChunkLoaderMod.MOD_ID + "_mod_tab";
    private static final String COMMAND_TAB_TITLE = BASE_TAB_TITLE + "mod_tab";
    ...
    public static final Supplier<CreativeModeTab> COMMAND_TAB = CREATIVE_MODE_TAB.register(
            COMMAND_TAB_ID, () -> CreativeModeTab.builder()
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        output.accept(ModBlocks.CHUNK_ANCHOR.asItem());
                    })
                    .build());
